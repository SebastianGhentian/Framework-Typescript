...
exports.User = User;
},{"./Model":"src/models/Model.ts","./Attributes":"src/models/Attributes.ts","./Sync":"src/models/Sync.ts","./Eventing":"src/models/Eventing.ts"}],"src/views/CollectionView.ts":[function(require,module,exports) {
"use strict";
...
},{"./CollectionView":"src/views/CollectionView.ts","./UserShow":"src/views/UserShow.ts"}],"src/models/Collection.ts":[function(require,module,exports) {
"use strict";
...
},{"axios":"node_modules/axios/index.js","./Eventing":"src/models/Eventing.ts"}],"index.ts":[function(require,module,exports) {
"use strict";
...
var Collection_1 = require("./src/models/Collection");

var userList = new Collection_1.Collection('http://localHost:3000/users', function (json) {
...
userList.on('change', function () {
  ...
  if (root) {
    new UserList_1.UserList(root, userList).render();
  }
});
userList.fetch(); // const user = User.buildUser({ name: 'NAME', age: 20})
...
// user.fetch();
// user.isAdminUser()
},{"./src/models/User":"src/models/User.ts","./src/views/UserList":"src/views/UserList.ts","./src/models/Collection":"src/models/Collection.ts"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
